    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-pruebaContratoEmpleados">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.empleado.fields.employeestatus') }}
                            </th>
                            <th>
                    ...
                    <tbody>
                        @foreach($empleados as $key => $empleado)
                            <tr data-entry-id="{{ $empleado->id }}">
                                ...
                                <td>
                                    {{ App\Models\Empleado::EMPLOYEESTATUS_SELECT[$empleado->employeestatus] ?? '' }}
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-pruebaContratoEmpleados:not(.ajaxTable)').DataTable({ buttons: dtButtons })
