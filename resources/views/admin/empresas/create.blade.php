    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.empresas.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('businessname') ? 'is-invalid' : '' }}" type="text" name="businessname" id="businessname" value="{{ old('businessname', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ruc') ? 'is-invalid' : '' }}" type="text" name="ruc" id="ruc" value="{{ old('ruc', '') }}" required>
                @if($errors->has('ruc'))
